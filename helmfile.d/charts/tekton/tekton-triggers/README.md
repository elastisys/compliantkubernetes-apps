...
| `controller.image.tag` | string | Controller docker image tag | `"v0.23.0"` |
...
| `version` | string | Tekton triggers version used to add labels on deployments, pods and services | `"v0.23.0"` |
...
| `webhook.image.tag` | string | Webhook docker image tag | `"v0.23.0"` |
