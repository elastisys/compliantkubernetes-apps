...
for release in "${releases[@]}"; do
  ...
  for cluster in sc wc; do
    bats_test_function --description "template is consistent - baremetal kubespray ${cluster} ${release}" --tags resources -- template_test "${cluster}" "${release}"
  done
done
