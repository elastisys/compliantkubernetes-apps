...
validate_config() {
    ...
    if [[ $1 == "sc" ]]; then
        ...
        check_conditionals "${secrets[secrets_file]}" "${config_template_path}/secrets/sc-secrets.yaml"
        ...
        check_conditionals "${secrets[secrets_file]}" "${config_template_path}/secrets/wc-secrets.yaml"
