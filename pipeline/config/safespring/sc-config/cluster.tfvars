...
cluster_name = "pipeline-safespring-sc"
...
master_allowed_remote_ips = ["194.103.95.251/32", "185.189.28.150/32", "185.189.28.233/32", "193.11.89.182/32", "193.11.89.183/32"]
...
additional_server_groups = {
  ...
  # Use if it's not possible to schedule all nodes using a single server group
