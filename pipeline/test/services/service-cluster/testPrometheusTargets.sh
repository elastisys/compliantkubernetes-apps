...
scTargets=(
    ...
    "serviceMonitor/monitoring/blackbox-prometheus-blackbox-exporter-user-api-server/0 1"
    "serviceMonitor/monitoring/blackbox-prometheus-blackbox-exporter-dex/0 1"
    "serviceMonitor/monitoring/blackbox-prometheus-blackbox-exporter-grafana/0 1"
    "serviceMonitor/monitoring/blackbox-prometheus-blackbox-exporter-opensearch-dashboards/0 1"
